  ...
  return (
    <Section id="testimonials">
      <div className="space-y-4">
        <Heading>Developers who ship fast love OneMinute Logs.</Heading>

        <div className="group mt-6 relative flex flex-col gap-6 mask-linear-fade w-[95%] md:w-[calc(100%-8rem)] mx-auto">
