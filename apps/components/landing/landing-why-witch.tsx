          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-950/80 p-6 sm:p-7 hover:border-slate-700 transition-colors duration-300">
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              {[
                ...
                {
                  icon: Hourglass,
                  text: "Slow searches when you're under pressure.",
                },
                {
                  icon: FileText,
                  text: "YAML everywhere and confusing config files.",
                },
                {
                  icon: Wallet,
                  text: "Pay for storage and infra you barely use.",
                },
              ].map((item, i) => (
          ...
          <div className="rounded-2xl border border-sky-500/30 bg-slate-950/90 p-6 sm:p-7 shadow-[0_0_20px_-5px_rgba(56,189,248,0.18)] hover:shadow-[0_0_30px_-5px_rgba(56,189,248,0.3)] hover:border-sky-500/50 transition-all duration-300">
            ...
            <ul className="space-y-3 text-sm ">
              {[
                {
                  icon: Zap,
                  text: "Set up in under a minute with a tiny SDK.",
                },
                {
                  icon: Search,
                  text: "Instant search that feels as fast as your editor.",
                },
                {
                  icon: FileJson,
                ...
                {
                  icon: Wrench,
                  text: "Get webhook alerts for critical events.",
                },
              ].map((item, i) => (
                <li key={i} className="flex items-start gap-2">
